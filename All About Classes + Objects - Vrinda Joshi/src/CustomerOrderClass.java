...
public class CustomerOrderClass extends JFrame implements ActionListener {
	...
	private JLabel lady = new JLabel(new ImageIcon(
			new ImageIcon("images/lady.png").getImage().getScaledInstance(100, 115, java.awt.Image.SCALE_SMOOTH)));
	private JLabel speech = new JLabel(new ImageIcon(new ImageIcon("images/speech.png").getImage()
			.getScaledInstance(1280 / 5, (int) 964 / 6, java.awt.Image.SCALE_SMOOTH)));
	...
	public CustomerOrderClass(int customerNumber) {
		...
		speechText = new JLabel(
				"<html>your " + number[customerNumber - 1] + " customer<br> requested the following:</html>");
		order = new JLabel(new ImageIcon(new ImageIcon("images/orders/order" + customerNumber + ".png").getImage()
