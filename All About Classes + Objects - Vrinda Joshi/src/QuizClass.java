...
public class QuizClass extends JFrame implements ActionListener {
	...
	int numQuestions = 8; // number of questions

	// panels
	private JPanel mainPanel = new JPanel();
	private JPanel topPanelOne = new JPanel();
	private JPanel topPanelTwo = new JPanel();
	private JPanel questionsPanel = new JPanel(); // big panel
	private JPanel[] questionPanelArray = new JPanel[numQuestions]; // smaller panels on questionsPanel

	private JLabel firstHeader = new JLabel("the final quiz"); // 1st header
	...
	private JLabel titleLabel = new JLabel("final quiz"); // 2nd header
	...
	public QuizClass() {
		...
		initializeArrays(); // set values for each element

		setLayout(null);
		setVisible(true);

		// modified the code from https://www.youtube.com/watch?v=0cATENiMsBE to create
		// a countdown (10 minutes)
		timer = new Timer(1000, new ActionListener() {

			public void actionPerformed(ActionEvent e) {

				timeArray[2] -= 1000; // time left

				timeArray[0] = (timeArray[2] / 60000) % 60; // hours
				timeArray[1] = (timeArray[2] / 1000) % 60; // minutes
	...
	private void initializeArrays() {
		...
		// add questions to respective panel
	...
	private void setSecondPanel() {
		...
		setJMenuBar(null); // https://stackoverflow.com/questions/9954169/java-remove-jmenubar
		...
		finishQuiz.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				timer.stop();
				if (gradeTest()) {
					JOptionPane.showMessageDialog(mainPanel, "You passed! You got " + mark + "% on the quiz.",
