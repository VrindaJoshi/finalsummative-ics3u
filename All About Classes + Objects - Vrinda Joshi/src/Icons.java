// ICONS
// creates the imageicon constants for the elements on screen
...
public class Icons {
	...
	public static final ImageIcon[] USER = { new ImageIcon("images/images/userInvert.png"),
			new ImageIcon("images/images/userInvert.png"), new ImageIcon("images/images/user.png"),
			new ImageIcon("images/images/user.png"), };

	public static final ImageIcon[] CUSTOMER = { new ImageIcon("images/images/dog1.png"),
			new ImageIcon("images/images/dog2.png"), new ImageIcon("images/images/dog3.png"),
